...
<head>
    ...
    <title>Login - Online Books Buying & Selling Store</title>
</head>
<body class="card col-lg-10 col-md-11 mx-auto p-0 bg-dark">
    <?php include "header.php"; ?>
    
    
    <form class="row p-3 card col-md-6 mx-auto mt-3" id="login_form"></form>

    <div class="text-center mt-1 pt-1"><a href="password_reset.php">Forgot Password? Click here to reset... </a></div>
    ...
    console.log("Login result: " + login_result);
        ...
        renderForm(login_form, "#login_form");
    }
