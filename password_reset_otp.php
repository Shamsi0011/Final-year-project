...
<head>
    ...
    <title>Enter OTP to Reset Your Password - Online Books Buying & Selling Store</title>
</head>
<body class="card col-lg-10 col-md-11 mx-auto p-0 bg-dark">
    <?php include "header.php"; ?>
    
    <form class="row p-3 card col-md-6 mx-auto mt-3" id="password_reset_otp_form"></form>
    ...
    console.log("Login result: " + login_result);
        ...
        renderForm(password_reset_otp_form, "#password_reset_otp_form");
    }
