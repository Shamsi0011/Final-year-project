...
<head>
    ...
    <title>Pending Posts - Online Books Buying & Selling Store</title>
</head>
<body class="card col-lg-10 col-md-11 mx-auto p-0 bg-dark">
    <?php include "header.php"; ?>
    <div class="card-header">
        <!-- Title -->
        <h4 class="card-title"><a>Pending Posts</a></h4>
    </div>
    <!-- Card content -->
    <div class="card-body" id="pending_posts">
        ...
        console.log("Login result: " + login_result);
            ...
            if(userObj.user_type_title=="admin"){
                ...
                if(userObj.user_type_title=="admin") {
                        ...
                        listPendingPosts("#pending_posts");
